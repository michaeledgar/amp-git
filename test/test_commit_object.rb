...
class TestGitCommitObject < AmpTestCase
  ...
  def test_tree_ref
    assert_equal "ecb7b4460825bed7c0bc6d17004816d15ae32c5e".unhexlify, @commit_obj.tree_ref
  end
  
  def test_parent_refs
    assert_equal ["8c27219d73786aa2e91d5ae964624ef36696c307".unhexlify], @commit_obj.parent_refs
  end
